...
:param drone_lat: 始点の緯度
:param drone_lon: 始点の経度
:param goal_lat: 終点の緯度
:param goal_lon: 終点の経度
:param ellipsoid: 楕円体
:return: 距離と方位角
'''
def vincenty_inverse(drone_lat, drone_lon, goal_lat, goal_lon, ellipsoid=None):
...
drone_location = drone.get_state(HomeChanged)
drone_lat = drone_location["latitude"]   # droneの緯度
drone_lon = drone_location["longitude"]  # droneの経度
goal_lat = 35.7097440  # goalの緯度
goal_lon = 139.5231003  # goalの経度

result = vincenty_inverse(drone_lat, drone_lon, goal_lat, goal_lon, 1)
