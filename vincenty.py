...
get_gps = drone.get_state(GpsLocationChanged)
drone_lat = get_gps["latitude"]   # droneの緯度
drone_lon = get_gps["longitude"]  # droneの経度
goal_lat = 24.4559224  # goalの緯度
goal_lon = 122.9187629 # goalの経度
